...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    admissionClosingDescription: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Admission Closing In 5 Days'>;
    bannerDescription: Schema.Attribute.String;
    bannerImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    bannerTitle: Schema.Attribute.String;
    brochure: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domain: Schema.Attribute.String & Schema.Attribute.Required;
    hero: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
